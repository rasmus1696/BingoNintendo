...
let Tab1Page = class Tab1Page {
    constructor(formBuilder, toastController, loadingController) {
    ...
    ngOnInit() {
        this.bingoForm = this.formBuilder.group({
            nombre: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.minLength(5)]],
            opcion1: [false],
            opcion2: [false],
            opcion3: [false],
            opcion4: [false],
